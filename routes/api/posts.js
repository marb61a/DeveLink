...
// @route POST/routes/api/posts/like/:id
// @desc Like a post
// @access Private 
    ...
    .then(profile => {
      Post.findById(req.params.id)
        .then(post => {
          ...
          // Add the user array to the likes id
...
// @route POST/routes/api/posts/unlike/:id
// @desc Unlike a post
// @access Private 
...
// @route POST /routes/api/posts/comment/:id
...
// @route DELETE /routes/api/posts/comment/:id/:comment_id
